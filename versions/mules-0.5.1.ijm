 ...
 *	
 * stdDev filter only outputs a log file for manual removal of leaf images...
 *  > need to expand it to auto-remove or re-label the offending images
 *  >> this means setting the label in the results table/ before the 'redblue()' cropped save
 *  
...
#@ String 	(label = "Troubleshooting for dark leaf on black background", choices=("yes", "no"), value="no", persist=false, style="radioButtonHorizontal") trbsht
